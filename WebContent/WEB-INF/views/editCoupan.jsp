...
<div>
<form:form   modelAttribute="coupan" action="/CaseStudyMVC/spring/updateCoupan" method="post">
 <table class="table table-stripped table-responsive table-hover">
 

 <tr>
 <td><form:label path="coupanid" >Coupon Id:</form:label></td>
 <td><form:input path="coupanid" value="${coupon.coupanid}" readonly="false" /></td>
 ...
 <td><form:errors path="eveid" cssClass="error" /></td>
  ...
  <tr>
 <td colspan="2"><input type="submit" value="Update Coupon"/></td>
 </tr>
 </table>
 </form:form>
</div>
